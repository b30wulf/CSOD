...
type
    ...
    Public
     ...
     procedure OnAddRowRegion_ES; //Управление деревом

     procedure OnAddRowAbon; //Добавление Абонента
...
Begin
    ...
    if FsgGrid.Cells[5,i]=''  then Begin if m_nPlaneList.Count<>0 then FsgGrid.Cells[5,i] := m_nPlaneList.Strings[0] else FsgGrid.Cells[5,i] :='тариф по умолчанию'; End;
