...
begin
  ...
  if OpenPort then TraceL(1,0,'(__)CL1MD::>—ŒÃ ÔÓÚ Œ ::'+IntToStr(PortNum)+':'+IntToStr(ManualRate))
  else TraceL(1,0,'(__)CL1MD::>Œ¯Ë·Í‡ ÓÚÍ˚ÚËˇ —ŒÃ ÔÓÚ‡:'+IntToStr(PortNum));
  Fl.Destroy;
End;
...
Begin
  ...
  if OpenPort then TraceL(1,0,'(__)CL1MD::>—ŒÃ ÔÓÚ Œ ::'+IntToStr(PortNum)+':'+IntToStr(ManualRate))
  else TraceL(1,PortNum,'(__)CL1MD::>Œ¯Ë·Í‡ ÓÚÍ˚ÚËˇ —ŒÃ ÔÓÚ‡: '+IntToStr(PortNum));
End;
...
begin
  ...
  if OpenPort then TraceL(1,0,'(__)CL1MD::>—ŒÃ ÔÓÚ Œ ::'+IntToStr(PortNum)+':'+IntToStr(ManualRate))
  else TraceL(1,0,'(__)CL1MD::>Œ¯Ë·Í‡ ÓÚÍ˚ÚËˇ —ŒÃ ÔÓÚ‡');
  //Fl.Destroy;
End;
