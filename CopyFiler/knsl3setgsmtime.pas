...
type
    ...
    Public
     property PlbSetTmState   :PTLabel read FlbSetTmState   write FlbSetTmState;
     property PlbSExpired     :PTLabel read FlbSExpired     write FlbSExpired;
    End;
    TMyDialParam = Record
     AMsg:Integer;
...
Begin
     ...
     PlbSetTmState.Caption := m_pTable.m_sMdmJoinName;
...
Begin
     case pMsg.m_sbyType of
      ...
      Begin
       ...
       if m_blIsSlave=True then SendRSMsg(CreateMSG(BOX_L3,0,DIR_LHTOLMC,NL_FINALCORR_REQ));
      End;
      DL_GSM_DEL_SRV_TMR:
...
Begin
     ...
     try
      ...
      Begin
       if m_blIsSlave=True then SendRSMsg(CreateMSG(BOX_L3,0,DIR_LHTOLMC,NL_STARTCORR_REQ));
...
Begin
     ...
     Begin
      if m_blIsNoSynchro=False then
      Begin
       PlbSetTmState.Caption:='Start Synchronize...';
       LastTime:=Now;
