...
begin
   ...
   Excel.ActiveSheet.Cells[posToWrite,1].Value := 'Трехминутная мощность на ' + DateTimeToStr(Now);
...
begin
   ...
   Excel.ActiveSheet.Cells[posToWrite,2].Value := 'Значение';
   Excel.ActiveSheet.Cells[posToWrite,3].Value := 'Значение/Лимит (%)';
   Excel.ActiveSheet.Cells[posToWrite,4].Value := 'Лимит';
   posToWrite := posToWrite + 1;
end;
