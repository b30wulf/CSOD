...
Begin
    ...
    //FsgGrid.Cells[4,0]  := 'Сокр.Назв.';
    FsgGrid.Cells[4,0]  := 'Обозначение';
    FsgGrid.Cells[5,0]  := 'Ед.Изм.';
    FsgGrid.Cells[6,0]  := 'П-д сохр(с)';
    FsgGrid.Cells[7,0]  := 'Тар.';
    FsgGrid.Cells[8,0]  := 'Акт.';
    FsgGrid.Cells[9,0]  := 'Статус';
    FsgGrid.Cells[10,0] := 'Тип хр.';
    FsgGrid.Cells[11,0] := 'Тип данных';
    FsgGrid.Cells[12,0] := 'П-д';
...
Begin
    ...
    if FsgGrid.Cells[3,i]='' then FsgGrid.Cells[3,i]  := 'Ен.Суммарная накопленная';
    //if FsgGrid.Cells[4,i]='' then FsgGrid.Cells[4,i]  := 'EN.Sum.Nak';
    if FsgGrid.Cells[4,i]='' then FsgGrid.Cells[4,i]  := 'E+';
    if FsgGrid.Cells[5,i]='' then FsgGrid.Cells[5,i]  := 'кВт';
