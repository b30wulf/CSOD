{*********************************************************}
{                                                         }
{     TMParser 10.1 for Borland Delphi                     }
{                                                         }
...
type
  ...
  TMParserExceptionEvent = procedure (Sender: TObject; E: Exception) of object;
  ...
  private
    ...
    FOnParserError : TMParserExceptionEvent;
  ...
  published
    ...
    property OnParserError: TMParserExceptionEvent read FOnParserError write FOnParserError;
  end;




  TMParser = class(TCustomParser)
  public
...
procedure Register;
begin
  RegisterComponents('Samples', [TMParser]);
end;
(*
{$IFDEF VER80}
  {$R *.D16}
...
{                                                                }
{****************************************************************}
constructor TMParser.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
...
class function TMParser.RemoveBlanks(const s: string): string;
