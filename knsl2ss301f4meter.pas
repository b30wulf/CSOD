...
type
    ...
    End;
implementation
constructor CSS301F4Meter.Create;
Begin
End;



procedure CSS301F4Meter.InitMeter(var pL2:SL2TAG);
Begin
    m_nCounter := 0;
    m_nCounter1:= 0;
    IsUpdate   := 0;
...
End;
procedure CSS301F4Meter.MsgHead(var pMsg:CHMessage; Size:byte);
begin
    pMsg.m_swLen       := Size;
    ...
    pMsg.m_sbyServerID := MET_SS301F4;     //Указать тип счетчика
    pMsg.m_sbyDirID    := m_nP.m_sbyPortID;
end;

procedure CSS301F4Meter.MsgHeadForEvents(var pMsg:CHMessage; Size:byte);
begin
    pMsg.m_swLen       := Size;
    pMsg.m_swObjID     := m_nP.m_swMID;       //Сетевой адрес счётчика
...
procedure CSS301F4Meter.SetCurrQry;
Begin
    with m_nObserver do
    Begin
     ClearCurrQry;
...
procedure CSS301F4Meter.AddEnergyDayGraphQry(dt_Date1, dt_Date2 : TDateTime);
...
procedure CSS301F4Meter.AddEnergyMonthGrpahQry(dt_Date1, dt_Date2 : TDateTime);
var TempDate    : TDateTime;
    i           : integer;
begin
   if m_nOnAutorization = 1 then
...
procedure CSS301F4Meter.AddSresEnergGrpahQry(dt_Date1, dt_Date2 : TDateTime);
var TempDate    : TDateTime;
    i, Srez     : integer;
    h, m, s, ms : word;
    y, d, mn    : word;
...
procedure CSS301F4Meter.AddLastSresEnergGrpahQry(dt_Date1, dt_Date2 : TDateTime);
var
    TempDate         : TDateTime;
...
procedure CSS301F4Meter.AddNakEnDayGrpahQry(dt_Date1, dt_Date2 : TDateTime);
var TempDate    : TDateTime;
    i           : integer;
...
procedure CSS301F4Meter.AddNakEnMonthGrpahQry(dt_Date1, dt_Date2 : TDateTime);
var TempDate    : TDateTime;
    i           : integer;
begin
   if m_nOnAutorization = 1 then
...
procedure CSS301F4Meter.AddMaxPower(dt_Date1, dt_Date2 : TDateTime);
var TempDate    : TDateTime;
    i, j        : integer;
begin
   if m_nOnAutorization = 1 then
...
procedure CSS301F4Meter.AddKorrGraphQry(dt_Date1 : TDateTime; srezN, srezK : byte);
var d, mn, y : word;
    i        : byte;
begin
...
procedure CSS301F4Meter.AddEventsGraphQry();
var i : integer;
begin
   ...
   begin
     for i := 0 downto -32 do
       m_nObserver.AddGraphParam(QRY_JRNL_T2, i, 0, 0, 1);
     m_nObserver.AddGraphParam(QRY_SUM_KORR_MONTH, 0, 0, 0 ,1);
   end;
end;

procedure CSS301F4Meter.SetGraphQry;
begin
...
function CSS301F4Meter.SelfHandler(var pMsg:CMessage):Boolean;
Var
    res : Boolean;
Begin
    res := False;
...
procedure CSS301F4Meter.Autoriztion;
begin
...
procedure CSS301F4Meter.SetTime();
...
procedure CSS301F4Meter.KorrTime();
var Year, Month, Day           : word;
    Hour, Min, Sec, mSec       : word;
begin
    //m_nRepTimer.OffTimer;
...
procedure CSS301F4Meter.WriteDate(var pMsg : CMessage; param : word);
var i, temp          : shortint;
    Year, Month, Day : word;
    TempDate         : TDateTime;
    sm               : shortint;
...
function CSS301F4Meter.GetValue(var pMsg:CMessage;i:integer):Single;
Var
...
End;
procedure CSS301F4Meter.WriteValue(var pMsg:CMessage;i:integer);
Var
    fValue : Double;
begin
...
procedure CSS301F4Meter.WriteI(var pMsg:CMessage;i:integer);
Var
    fValue : Double;
begin
    fValue := RV(GetValue(pMsg,i));
...
procedure CSS301F4Meter.WriteU(var pMsg:CMessage;i:integer);
Var
    fValue : Double;
begin
    fValue := RV(GetValue(pMsg,i));
...
procedure CSS301F4Meter.WriteP(var pMsg:CMessage;i:integer);
Var
    fValue : Double;
begin
    //Operation
...
procedure CSS301F4Meter.WriteE(var pMsg:CMessage;i:integer);
Var
    fValue : Double;
begin
    //Operation
...
function  CSS301F4Meter.ProcessingData(var pMsg:CMessage; var i:integer) : boolean;
var Year, Month, Day       : word;
...
begin
    ...
    case (pMsg.m_sbyInfo[2]) of
      ...
      24:
      Begin
        move(m_nRxMsg.m_sbyInfo[8], Ke, 2);
        i := i + 4;
        FinalAction;
        Result := false;
      End;
...
function CSS301F4Meter.SendToL3(var pMsg:CMessage) : boolean;
    ...
    begin
     ...
     {$ENDIF}
      ...
      begin
        ...
        //TraceM(2,m_nRxMsg.m_swObjID,'(__)CL2MD::>SS301  SNDL3:',@m_nRxMsg);
...
function CSS301F4Meter.LoHandler(var pMsg:CMessage):Boolean;
Var
    res    : Boolean;
    fValue : Single;
Begin
...
procedure CSS301F4Meter.TestMessage(var pMsg:CMessage);
Var
...
procedure CSS301F4Meter.GetTimeValue(var nReq: CQueryPrimitive);
var Year, Month, Day       : word;
...
procedure CSS301F4Meter.HandQryRoutine(var pMsg:CMessage);
Var
...
function CSS301F4Meter.HiHandler(var pMsg:CMessage):Boolean;
Var
    res          : Boolean;
    //nReq         : CQueryPrimitive;
    tempP        : ShortInt;
Begin
    ...
    Result := res;
End;
procedure CSS301F4Meter.OnEnterAction;
Begin
    TraceL(4,m_nP.m_swMID,'(__)CL2MD::>SS301 OnEnterAction');
    if (m_nP.m_sbyEnable=1)and(m_nP.m_sbyModem=1) then
    OpenPhone else
    if (m_nP.m_sbyModem=0) then FinalAction;
    //FinalAction;
End;
procedure CSS301F4Meter.OnFinalAction;
Begin
    TraceL(4,m_nP.m_swMID,'(__)CL2MD::>SS301 OnFinalAction');
    ...
    FinalAction;
End;
procedure CSS301F4Meter.OnConnectComplette(var pMsg:CMessage);
Begin
    TraceL(4,m_nP.m_swMID,'(__)CL2MD::>SS301 OnConnectComplette');
    m_nModemState := 1;
    FinalAction;
End;
procedure CSS301F4Meter.OnDisconnectComplette(var pMsg:CMessage);
Begin
    TraceL(4,m_nP.m_swMID,'(__)CL2MD::>SS301 OnDisconnectComplette');
    m_nModemState := 0;
    SendMSG(BOX_L2,DIR_QMTOL2,DL_ERRTMR_IND);
    //FinalAction;
End;
procedure CSS301F4Meter.OnFinHandQryRoutine(var pMsg:CMessage);
begin
...
function CSS301F4Meter.GetCommand(byCommand:Byte):Integer;
Var
    res : Integer;
Begin
    case byCommand of
    ...
    Result := res;
End;
function CSS301F4Meter.CRC(var buf : array of byte; cnt : byte):boolean;
var
    CRChiEl             : byte;
    CRCloEl             : byte;
    i                   : byte;
...
procedure CSS301F4Meter.RunMeter;
Begin
