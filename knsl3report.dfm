object TRepPower: TTRepPower
  ...
  object pcReport: TAdvOfficePager
    ...
    object tshCurrVals: TAdvOfficePage
      ...
      Width = 1361
      Height = 482
      Caption = 'Текущие показания электроэнергии'
      ImageIndex = 3
      PageAppearance.BorderColor = 11841710
      PageAppearance.Color = 13616833
      PageAppearance.ColorTo = 12958644
    ...
    object tshOptions: TAdvOfficePage
      ...
      object Label4: TLabel
        ...
        Width = 195
        Height = 14
        Caption = 'Код отделения в кодировке Энергосбыта'
      end
      ...
      object Edit2: TEdit
        ...
        Height = 22
        TabOrder = 3
        Text = 'Представитель Энергонадзора1___________________________'
      end
      object Edit7: TEdit
        Left = 24
        Top = 217
        ...
        Height = 22
        TabOrder = 4
        Text = 'Представитель Энергонадзора2___________________________'
      end
      object Edit6: TEdit
        Left = 376
        Top = 30
      ...
      object Edit3: TEdit
        ...
        Height = 22
        TabOrder = 8
        Text = 'Представитель Потребителя_____________________________'
      end
    ...
    object tshAnalisBalansObj: TAdvOfficePage
      ...
      Width = 1361
      Height = 482
      Caption = 'Анализ баланса потребления по объекту'
      PageAppearance.BorderColor = 11841710
      PageAppearance.Color = 13616833
      PageAppearance.ColorTo = 12958644
      PageAppearance.ColorMirror = 12958644
    ...
    object tshErrorMeterRegion: TAdvOfficePage
      ...
      Width = 1361
      Height = 482
      Caption = 'Отчет о неопрошенных счетчиках на конец месяца'
      PageAppearance.BorderColor = 11841710
      PageAppearance.Color = 13616833
      PageAppearance.ColorTo = 12958644
      PageAppearance.ColorMirror = 12958644
    ...
    object tshErrorReportDay: TAdvOfficePage
      ...
      Width = 1361
      Height = 482
      Caption = 'Отчет об ошибках опроса счетчиков за день'
      PageAppearance.BorderColor = 11841710
      PageAppearance.Color = 13616833
      PageAppearance.ColorTo = 12958644
      PageAppearance.ColorMirror = 12958644
  ...
  object AdvPanel1: TAdvPanel
    ...
    object cbKindEnerg: TComboBox
      ...
      Items.Strings = (
        'Активная принимаемая энергия'
        'Активная отдаваемая энергия'
        'Реактивная принимаемая энергия'
        'Реактивная отдаваемая энергия')
    end
    ...
    object cb_WithKT: TCheckBox
      ...
      Width = 190
      Height = 17
      Caption = 'С учетом коэффициентов трансформации'
      TabOrder = 13
    end
    ...
    object BalanceCheckBox: TCheckBox
      ...
      Width = 209
      Height = 18
      Caption = 'Переключить на суточный отчет'
      TabOrder = 16
