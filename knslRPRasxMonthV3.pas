{**
 * Project:     Konus-2000E
 * File:        knslRPRasxMonthV3.pas
 * Description: Модуль отчета "Расход за сутки (Вид 3)"
 *
 * Delphi version 5
 *
 * Category    Reports
 ...
 * Link        Reports/RasxMonthV3
 *}

unit knslRPRasxMonthV3;
...
var
  f_RPRasxMonthV3: TRPRasxMonthV3;
const
...
procedure TRPRasxMonthV3.SetHigthGrid(var sgGrid:TAdvStringGrid;nHigth:Integer);
Var
    i : Integer;
Begin
...
procedure TRPRasxMonthV3.OnFormResize;
var
    i : Integer;
begin
...
procedure TRPRasxMonthV3.PrepareTable;
...
procedure TRPRasxMonthV3.PrintPreview(Date : TDateTime);
var
...
function TRPRasxMonthV3.Replace(Str, X, Y: string): string;
var
...
procedure TRPRasxMonthV3.FindValueFormula(tarif:integer;KindEn: byte;mid:string);
var
 stReplace : string;
 i:byte;
begin
...
procedure TRPRasxMonthV3.FillReport(MID : integer; var Page: TfrPage);
var Data                : CCDatas;
    KindEn              : byte;
...
procedure TRPRasxMonthV3.FillReportTtl(KindEN : byte; var Page : TfrPage);
var i : byte;
begin
  PH_KindEnergy := c_EnergyTitles[KindEN];
...
procedure TRPRasxMonthV3.frReportManualBuild(Page: TfrPage);
var i, j             : integer;
...
procedure TRPRasxMonthV3.frReportGetValue(const ParName: String; var ParValue: Variant);
begin
...
procedure TRPRasxMonthV3.frReportEnterRect(Memo: TStringList;
  View: TfrView);                                         
begin
   if IsLastPage then
