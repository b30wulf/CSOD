...
begin
   ...
   begin
  // if (gidGroup.PARAM<>QRY_LOAD_ALL_PARAMS)then   //тест
   // begin
...
///////—четчики используют глобальный хаус таск//////////////
...
begin
   ...
   pTable:= getL2Instance(dyncon,pD.m_swMID);
   begin
//   if (gidGroup.PARAM<>QRY_LOAD_ALL_PARAMS) or (dataQqAbon.ENABLE_PROG<>1)then   //тест
    begin
    case pTable.m_sbyType of
